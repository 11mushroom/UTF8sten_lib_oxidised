...
on social platforms or in chats you usually can't send raw binary data and the best thing you can use as workaround is base64<br/>
...
also on some platforms symbols from range U+20000 counts as 2 symbols, resulting in ratio `symbols:bytes` = `1:1`, which is worse than regular `u8s`.
